...
class SimpleImage {
  ...
  render() {
    ...
    caption.dataset.placeholder = 'Описание';
  ...
  /**
    ...
    */
  //  ts-ignore
  _make(tagName, classNames = null, attributes = { id: this.readOnly }) {
  ...
  _acceptTuneView() {
    this.settings.forEach((tune) => {
      ...
      if (this.readOnly) {
        this.nodes.imageHolder.addEventListener('click', () => {
          this.nodes.imageHolder.classList.toggle('zoom');
        });
      }
