 ...
 *  2) uploader.js — module
 * that has methods for sending files via AJAX: from device, by URL or File pasting
 ...
 * Promise.<UploadResponseFormat>} [uploader.uploadByFile] - method that upload image by File
 * @property {function(string):
 * Promise.<UploadResponseFormat>} [uploader.uploadByUrl] - method that upload image by URL
 */
...
export default class ImageTool {
  ...
  constructor({
    ...
    this.config = {
      ...
      captionPlaceholder: this.api.i18n.t(config.captionPlaceholder || 'Описание'),
   ...
   * @returns {{tags: string[],
   *  patterns: object<string, RegExp>, files: {extensions: string[], mimeTypes: string[]}}}
   */
